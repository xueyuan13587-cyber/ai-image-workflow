...
const STYLE_TEXT: Record<string, string> = {
  ghibli: "warm hand-painted animation background style, gentle natural light, whimsical atmosphere, soft painterly detail",
  cyberpunk: "cyberpunk neon city mood, high contrast lighting, futuristic tech details, electric color accents",
  popmart: "cute collectible blind-box toy aesthetic, rounded character forms, glossy vinyl material, playful studio look",
  "japanese-anime": "Japanese anime key visual style, clean expressive character design, crisp linework, vibrant color",
  cinematic: "cinematic lighting, high detail, dramatic composition",
  product: "premium product render, studio lighting, sharp focus",
  "apple-ad": "minimal premium technology advertising style, clean white space, elegant product focus, soft natural shadows",
